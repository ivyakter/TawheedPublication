<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DefaultMaster.master" AutoEventWireup="true" CodeFile="AllBooks.aspx.cs" Inherits="Pages_AllBooks" %>
                        ...
                        <div class="">
                            <div class="">
                                <asp:DropDownList CssClass="form-control" runat="server" ID="ddlSort" AutoPostBack="true" OnSelectedIndexChanged="ddlSort_SelectedIndexChanged">
                                    <%--  <asp:ListItem Value="1">Sort by average rating</asp:ListItem>--%>
                                    <%--  <asp:ListItem Value="2">Sort by popularity</asp:ListItem>--%>
                                    <asp:ListItem Value="3">Sort by newness</asp:ListItem>
                                    <asp:ListItem Value="4">Sort by price: low to high</asp:ListItem>
                                    <asp:ListItem Value="5">Sort by price: high to low</asp:ListItem>
                                    <asp:ListItem Value="6">Product Name: Z</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="page_amount">
                            <div class="add_to_cart1">
                                <a href="../lib/PDF/1.pdf" download>Download PDF</a>
                            </div>
                        </div>
                    </div>
                    <!--shop toolbar end-->
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-12">
                            ...
                            <div class="row shop_wrapper">
                                <asp:Repeater runat="server" ID="repeaterBooks" OnItemDataBound="repeaterBooks_ItemDataBound">
                                    <ItemTemplate>
                                                ...
                                                <figure>
                                                    <div class="product_thumb">
                                                        ...
                                                        <a class="secondary_img" href='<%# String.Concat("ProductDetails.aspx?PID=", Eval("Id").ToString()) %>'>
                                                            <img style="width: 100%; height: 305px;" src="../BookImage/<%#Eval("Code") %>/<%#Eval("Code") %>Back<%#Eval("FontImage") %>" onerror="this.src='<%=Page.ResolveUrl("~") %>BookImage/DefaultBook.jpg'" alt=""></a>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceFilterByCategory" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ServerDb %>"
                            SelectCommand="select *
                                            from Books, tblBookCategories
                                            where tblBookCategories.BookId = Books.Id
                                            and Books.categoryId = @Id">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="chkBoxCategories"
                                    Name="Id" PropertyName="SelectedValue" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="SqlDataSourceFilterByAuthor" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ServerDb %>"
                            SelectCommand="select *
                                            from Books, tblBookAuthors, Writer
                                            where tblBookAuthors.BookId = Books.Id
                                            and tblBookAuthors.AuthorId = Writer.Id
                                            and Writer.Id = @Id">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="chkBoxAuthors"
                                    Name="Id" PropertyName="SelectedValue" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                            </div>
