<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DefaultMaster.master" AutoEventWireup="true" CodeFile="Writer.aspx.cs" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Inherits="Pages_Writer" %>
            ...
            <div class="row">
                <asp:Panel ID="Panel1" runat="server">
                    <div class="col-lg-12 col-md-12">
                        <%--<img src="../assets/img/logo/publication.png" />--%>
                        <img src="../assets/img/logo/writer.jpg" />

                        <br />
                        <br />
                        <p>একজন লেখক হলেন এমন একজন ব্যক্তি, যিনি বিভিন্ন ধরনের এবং কৌশলের লিখিত শব্দগুলি যোগাযোগের জন্য ব্যবহার করেন। লেখকরা বিভিন্ন ধরনের সাহিত্য শিল্প এবং সৃজনশীল লেখার জন্মদান করেন, যেমন উপন্যাস, ছোট গল্প, কবিতা, নাটক, চিত্রনাট্য এবং প্রবন্ধ পাশাপাশি বিভিন্ন প্রতিবেদন গুলি এবং খবর নিবন্ধ যার প্রতি জনগণ আগ্রহী হতে পারে। লেখকদের লেখা বিভিন্ন মাধ্যমে প্রকাশিত হয়। দক্ষ লেখক, যাঁরা ভাষার মাধ্যমে ধারণাকে ভালভাবে প্রকাশ করতে ব্যবহার করতে সক্ষম হন, একটি সমাজের সংস্কৃতিতে তাঁদের অবদান অপরিসীম।</p>
                        <br />
                        <br />
                        <hr />
                        <!--Popular Writer area start-->
                        <section class="product_area mb-46">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="section_title">
                                            <h2>জনপ্রিয় লেখকগণ</h2>
                                        </div>
                                    </div>
                                </div>

                                <div class="sliderclass">
                                    <asp:Repeater ID="rptPopularWriter" runat="server">
                                        <ItemTemplate>
                                            <article class="single_product">
                                                <figure>
                                                    <div class="product_thumb">
                                                        <a class="primary_img" href='<%# String.Concat("Writer.aspx?Writer=", Eval("Code").ToString()) %>'>
                                                            <img style="width: 184px; height: 184px;" src="../BookImage/Writer/<%#Eval("Extension") %>" onerror="this.src='<%=Page.ResolveUrl("~") %>assets/img/logo/writerlogo.jpg'" alt=""></a>
                                                        <figcaption class="product_content">
                                                            <h3 class="product_name"><a href="<%# String.Concat("Writer.aspx?Writer=", Eval("Code").ToString()) %>"><%# Eval("Name") %></a></h3>
                                                        </figcaption>
                                                    </div>
                                                </figure>
                                            </article>
                        ...
                        <section class="product_area mb-46">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="section_title">
                                            <h2>আপনার প্রিয় লেখক</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <div class="accordion_area" style="padding-bottom: 6px;">
                            <div class="container">
                                <div class="row">
                                    <asp:Repeater ID="rptAllWriter" runat="server">
                                        <ItemTemplate>
                                            <div class="col-3">
                                                <div id="accordion" class="card__accordion">
                                                    <div class="card card_dipult">
                                                        <a target="_blank" href='<%# String.Concat("Writer.aspx?Writer=", Eval("Code").ToString()) %>'>
                                                            <img title='<%#Eval("Name") %>' src="../BookImage/Writer/<%#Eval("Extension") %>" onerror="this.src='<%=Page.ResolveUrl("~") %>assets/img/logo/writerlogo.jpg'" alt=""></a>
                                                        <div class="card-header card_accor" id="headingOne">
                                                            <asp:Button ID="Button1" runat="server" Style="float: left; width: 90%; height: 80px;" class="btn btn-link" Text='<%#Eval("Name") %>' PostBackUrl='<%# String.Concat("Writer.aspx?Writer=", Eval("Code").ToString()) %>' />
                                                            <button style="float: right; width: 10%" class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="accordion_area" style="padding-bottom: 6px;">
                            <div class="container">
                                <div class="row">
                                    <asp:Repeater ID="rptWriter" runat="server">
                                        <ItemTemplate>
                                            <div class="col-12">
                                                <div id="accordion" class="card__accordion">
                                                    <div class="card card_dipult" style="display: inline-block; width: 100%">
                                                        <img title='<%#Eval("Name") %>' src="../BookImage/Writer/<%#Eval("Extension") %>" onerror="this.src='<%=Page.ResolveUrl("~") %>assets/img/logo/writerlogo.jpg'" style="float: left; margin: 0" alt="">
                                                        <div style="float: right; width: 80%; min-height: 140px;" class="card-header card_accor" id="headingOne">

                                                            <asp:Button ID="Button1" runat="server" class="btn btn-link" Text='<%#Eval("Name").ToString() %>' />
                                                            <asp:Button Style="height: 100%" ID="Button2" runat="server" class="btn btn-link" Text='<%#Eval("Description") %>' />
                                                            <button style="float: right; width: 10%" class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        ...
                        <asp:Label runat="server" ID="lblMessage" Visible="false" ForeColor="Red" Font-Size="XX-Large" Text="Sorry! we dont have any book related to your search please try another writer"></asp:Label>
                        <!--Accordion area end-->
