...
public partial class Pages_Publication : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString.ToString().Contains("Pub"))
            {
    ...
    {
        DataTable dt = bookManager.GetPublication();
        rptAllpublication.DataSource = dt;
        rptAllpublication.DataBind();
    }
    ...
    private void GetBooks()
    {
        ...
        var dt = bookManager.GetPublicationAllBooks(id);
