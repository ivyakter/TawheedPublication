<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SubCategory.aspx.cs" Inherits="Pages_Set_Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Manage SubCategory</h6>
            </div>
            <div class="card-body">
                ...
                <asp:Panel ID="panelCategoryTable" runat="server">
                    ...
                    <div class="col-md-4 fa-pull-left">
                        <asp:Button runat="server" ID="btnAddCategory" CssClass="btn btn-primary btn-sm" Text="Add SubCategory" OnClick="btnAddCategory_Click" />
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [Subject] ORDER BY [Id] DESC"></asp:SqlDataSource>
                    </div>
                </asp:Panel>
                    ...
                    <div class="mx-auto col-md-8">
                        <div class="form-group">
                            <div class="input-group flex-nowrap">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="addon-wrapping2">Select Category</span>
                                </div>
                                <asp:DropDownList AppendDataBoundItems="true" runat="server" ID="ddlCategory" class="custom-select">
                        ...
                        <div class="form-group">
                            <div class="input-group flex-nowrap">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="addon-wrapping">SubCategory Name</span>
                                </div>
                ...
                <asp:Panel runat="server" ID="panelDetail" Visible="false">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <asp:Label runat="server" ID="lblCategoryView"></asp:Label>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-3">
