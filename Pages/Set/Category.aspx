<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="Pages_Set_Category" %>
            ...
            <div class="card-body">
                ...
                <asp:Panel ID="panelCategoryTable" runat="server">
                    ...
                    <div class="col-md-4 fa-pull-left">
                        <asp:Button runat="server" ID="btnAddCategory" CssClass="btn btn-primary btn-sm" Text="Add Category" OnClick="btnAddCategory_Click" />
                    </div>
