<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DefaultMaster.master" AutoEventWireup="true" CodeFile="Books.aspx.cs" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Inherits="Pages_Books" %>
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="page_amount">
                            <div class="add_to_cart1">
                                <a href="../lib/PDF/TawheedPublication.pdf" download>Download Book list</a>
                            </div>
                        </div>
                    </div>
                        <div class="accordion_area" style="padding-bottom: 6px;">
                            <div class="container">
                                <div class="row shop_wrapper">
                                    <asp:Repeater runat="server" ID="repeaterallBooks" OnItemDataBound="repeaterBooks_ItemDataBound1">
                                        <ItemTemplate>
