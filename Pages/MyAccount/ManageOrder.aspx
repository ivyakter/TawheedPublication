<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageOrder.aspx.cs" Inherits="Pages_Set_ManageOrder" %>
                ...
                <div class="card-body">
                    ...
                    <asp:Panel ID="panelOrdersTable" runat="server">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gridViewOrders" DataSourceID="SqlDataSource2" class="table table-striped text-justify"
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton runat="server" ID="btnCancel" CssClass="btn btn-danger  btn-sm" CommandName="CancelOrder"
                                                ...
                                                OnClientClick="if ( ! Update()) return false;" meta:resourcekey="btnRemoveResource1">Cancel</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="SELECT * FROM [tblOrder] ORDER BY [Id] DESC"></asp:SqlDataSource>
                        </div>
                    </asp:Panel>
                    ...
                    <asp:Panel Visible="false" ID="panelCustomerList" runat="server">
                        <div class="col-md-4 fa-pull-right">
                            <div class="input-group mb-3">
                                ...
                                <asp:TextBox runat="server" type="text" class="form-control"
                                    ID="txtSearchCustomer" OnTextChanged="txtSearchCustomer_TextChanged" ></asp:TextBox>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <asp:GridView ID="gridViewCustomerList" runat="server" class="table table-striped text-justify"
