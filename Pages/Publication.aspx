<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DefaultMaster.master" AutoEventWireup="true" CodeFile="Publication.aspx.cs" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Inherits="Pages_Publication" %>
            ...
            <div class="row">
                <asp:Panel ID="Panel1" runat="server">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <img src="../assets/img/logo/publication.jfif" />
                       
                        <br />
                        <br />
                        <p>লক্ষাধিক বইয়ের সংগ্রহ । বইয়ের এই বিশাল সমুদ্র-মন্থনে পাঠকের সুবিধার্থে প্রায় ৫০ টির মতো ক্যাটাগরি ও সহস্রাধিক বিষয়ভিত্তিক ক্যাটাগরি রয়েছে এখানে। যার ফলে খুব সহজেই পাঠক তার পছন্দের ক্যাটাগরি বেছে নিয়ে নির্দিষ্ট বিষয়ভিত্তিক বইগুলো খুঁজে পাবে খুব সহজেই।  এই বিশাল বইয়ের সমুদ্রে জ্ঞানের জাহাজের নাবিক হতে আপনাকে নিমন্ত্রণ। মানচিত্রটা ধরা আছে নিচেই</p>
                        <br />
                        <br />
                        <hr />
                        <div class="accordion_area" style="padding-bottom: 6px;">
                            <div class="container">
                                <div class="row">
                                    <asp:Repeater ID="rptAllpublication" runat="server">
                                        <ItemTemplate>
                                            <div class="col-3">
                                                <div id="accordion" class="card__accordion">
                                                    <div class="card card_dipult">
                                                        ...
                                                        <div class="card-header card_accor" id="headingOne">
                                                            <asp:Button ID="Button1" runat="server" style="float: left; width: 90%" class="btn btn-link" Text='<%#Eval("Name") %>' PostBackUrl='<%# String.Concat("Publication.aspx?Pub=", Eval("Id").ToString()) %>' />
            ...
            <asp:Panel ID="Panel2" Visible="false" runat="server">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <asp:Label runat="server" ID="lblMessage" Visible="false" ForeColor="Red" Font-Size="XX-Large" Text="Sorry! we dont have any book related to your search please try another publication"></asp:Label>
                        <!--Accordion area end-->
